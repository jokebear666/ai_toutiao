...
- **[arXiv251224] Energy-Efficient Multi-LLM Reasoning for Binary-Free Zero-Day Detection in IoT Firmware**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Energy-Efficient Multi-LLM Reasoning for Binary-Free Zero-Day Detection in IoT Firmware

- **[arXiv251224] Efficient Mod Approximation and Its Applications to CKKS Ciphertexts**
  - **tags:** TBD
  - **authors:** Yufei Zhou
  - **institution:** TBD
  ...
  - **Simple LLM Summary:** Efficient Mod Approximation and Its Applications to CKKS Ciphertexts

- **[arXiv251224] Fast Deterministically Safe Proof-of-Work Consensus**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Fast Deterministically Safe Proof-of-Work Consensus
...
- **[arXiv251224] Optimistic TEE-Rollups: A Hybrid Architecture for Scalable and Verifiable Generative AI Inference on Blockchain**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Optimistic TEE-Rollups: A Hybrid Architecture for Scalable and Verifiable Generative AI Inference on Blockchain
...
- **[arXiv251224] Achieving Flexible and Secure Authentication with Strong Privacy in Decentralized Networks**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Achieving Flexible and Secure Authentication with Strong Privacy in Decentralized Networks

- **[arXiv251224] From the Two-Capacitor Paradox to Electromagnetic Side-Channel Mitigation in Digital Circuits**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** From the Two-Capacitor Paradox to Electromagnetic Side-Channel Mitigation in Digital Circuits

- **[arXiv251224] Differentially Private Feature Release for Wireless Sensing: Adaptive Privacy Budget Allocation on CSI Spectrograms**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Differentially Private Feature Release for Wireless Sensing: Adaptive Privacy Budget Allocation on CSI Spectrograms
...
- **[arXiv251224] ARBITER: AI-Driven Filtering for Role-Based Access Control**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** ARBITER: AI-Driven Filtering for Role-Based Access Control

- **[arXiv251224] Making Sense of Private Advertising: A Principled Approach to a Complex Ecosystem**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Making Sense of Private Advertising: A Principled Approach to a Complex Ecosystem

- **[arXiv251224] Fault Injection Attacks on Machine Learning-based Quantum Computer Readout Error Correction**
  - **tags:** TBD
  ...
  - **Simple LLM Summary:** Fault Injection Attacks on Machine Learning-based Quantum Computer Readout Error Correction
...
- **[arXiv251225] Anota: Identifying Business Logic Vulnerabilities via Annotation-Based Sanitization**
  - **tags:** [sec], [vulnerability detection], [business logic vulnerabilities, annotation-based sanitization, human-in-the-loop, fuzzing, dynamic analysis]
  ...
  - **Simple LLM Summary:** The paper addresses the challenge of detecting business logic vulnerabilities, which are often missed by traditional fuzzing sanitizers. It proposes ANOTA, a framework where users define intended behavior via annotations, and a runtime monitor detects deviations. Evaluation shows ANOTA combined with a fuzzer effectively finds such vulnerabilities, reproducing 43 known and discovering 22 new ones.
  - **Mindmap:**
...
- **[arXiv251225] Neutralization of IMU-Based GPS Spoofing Detection using external IMU sensor and feedback methodology**
  - **tags:** [sec], [GPS spoofing, sensor fusion security], [GPS Spoofing, IMU Sensor, EKF Sensor Fusion, Anomaly Detection, Autonomous Vehicles]
...
- **[arXiv251225] AegisAgent: An Autonomous Defense Agent Against Prompt Injection Attacks in LLM-HARs**
  - **tags:** [sec], [prompt injection defense], [autonomous agent, semantic inconsistency reasoning, dynamic memory, verification and repair plan, LLM-HAR security]
...
- **[arXiv251225] GateBreaker: Gate-Guided Attacks on Mixture-of-Expert LLMs**
  - **tags:** [sec], [adversarial attacks], [Mixture-of-Experts, safety alignment, adversarial attack, sparse routing, neuron ablation]
...
- **[arXiv251225] Industrial Ouroboros: Deep Lateral Movement via Living Off the Plant**
  - **tags:** [sec], [operational technology security], [lateral movement, living off the plant, programmable logic controller, serial network, covert technique]
...
- **[arXiv251225] Uncertainty in security: managing cyber senescence**
  - **tags:** [sec], [cybersecurity risk management], [cyber senescence, uncertainty, security controls, system aging, risk accumulation]
  ...
  - **Simple LLM Summary:** The paper introduces the concept of "cyber senescence" to describe the aging of the cybersecurity ecosystem, primarily caused by the accumulation of overlapping security controls whose risk reduction is uncertain. It argues that managing this fundamental uncertainty by pruning ineffective controls is necessary to prevent system collapse.
  - **Mindmap:**
...
- **[arXiv251225] Sequential Apportionment from Stationary Divisor Methods**
  - **tags:** [other], [computational social choice], [apportionment sequence, divisor methods, stationary divisor methods, house monotonicity, large-party bias]
...
- **[arXiv251225] Device-Independent Anonymous Communication in Quantum Networks**
  - **tags:** [sec], [quantum cryptography], [device-independent, anonymous communication, quantum networks, GHZ states, parity protocol]
...
- **[arXiv251225] A Note on Publicly Verifiable Quantum Money with Low Quantum Computational Resources**
  - **tags:** [sec], [quantum cryptography], [quantum money, one-time memories, conjugate coding, public verifiability, trusted hardware]
