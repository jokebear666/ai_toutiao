...
- **[arXiv260101] Hojabr: Towards a Theory of Everything for AI and Data Analytics**
  - **tags:** [mlsys], [compiler & ir], [declarative intermediate language, unified algebraic framework, bidirectional compilation, constraint-specialization, tensor algebra]
...
- **[arXiv260101] LMG Index: A Robust Learned Index for Multi-Dimensional Performance Balance**
  - **tags:** [mlsys], [memory & caching], [learned index, robust framework, gap allocation, performance balance, update efficiency]
