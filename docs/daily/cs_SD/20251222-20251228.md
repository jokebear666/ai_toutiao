...
- **[arXiv251225] SACodec: Asymmetric Quantization with Semantic Anchoring for Low-Bitrate High-Fidelity Neural Speech Codecs**
  - **tags:** [mlsys], [model compression (quantization/pruning)], [neural speech codec, asymmetric quantization, semantic anchoring, residual vector quantization, low-bitrate]
